...
class CustomRenderShrinkWrappingViewport extends CustomRenderViewport {
  ...
  void performLayout() {
    if (center == null) {
      assert(
        firstChild == null,
        'center must be null if children are present',
      );
    ...
    assert(
      center!.parent == this,
      'center must be a child of the viewport',
    );
  ...
  double _attemptLayout(
    ...
    assert(
      ...
      'The maxExtent of $this has not been set.',
    );
    assert(
      mainAxisExtent >= 0.0,
      'The maxExtent of $this is negative.',
    );
    assert(
    ...
    assert(
      crossAxisExtent >= 0.0,
      'The crossAxisExtent of $this is negative.',
    );
    assert(
...
abstract class CustomRenderViewport extends RenderViewportBase<CustomSliverPhysicalContainerParentData> {
  ...
  int get indexOfFirstChild {
    assert(
      center != null,
      'RenderViewport does not have any children.',
    );
    assert(
      center!.parent == this,
