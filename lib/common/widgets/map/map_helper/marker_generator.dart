...
// var mapMarker = <MarkerId, Marker>{};
// var center =
// getCenterCoordinates(response.regions?[i].coordinates ?? []);
// final markerId = MarkerId('marker_id_$i');
// mapMarker[markerId] = Marker(
// markerId: markerId, position: center, onTap: () {}, icon: icon);
//
// markers.addAll(mapMarker);
// }
// setState(() {});
// }).generate(context);