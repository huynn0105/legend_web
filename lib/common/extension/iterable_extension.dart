extension DistinctExtension<T> on Iterable<T> {
  ...
  ///
  /// After applying the [distinctByCondition] method to an iterable, the resulting
  ...
  /// one is provided, the [distinctByCondition] method will pass each element in the
  /// iterable to the [keySelector] callback and use the returned value to
  /// determine equivalency. Otherwise, the [distinctByCondition] method will use the
  /// element itself.
  ///
  ...
  ///       // Result: [0, 1, 2, 3]
  ///     }
  Iterable<T> distinctByCondition([Object Function(T element)? keySelector]) sync* {
